...
function createContextInfo(jid, text, title = "", body = "", thumbnail = null) {
  ...
  if (jid && text) {
    ...
    contextInfo.stanzaId = "UCPAIAI" + Date.now();
  }

  if (title || body || thumbnail) {
    contextInfo.externalAdReply = {
      showAdAttribution: true,
      title: title || config.bot?.name || "Ucpai-AI",
      body: body || "",
      mediaType: 1,
...
async function serialize(sock, msg, store = {}) {
  ...
  m.botName = sock.user?.name || config.bot?.name || "Ucpai-AI";
  m.messageId = m.id;
  m.chatId = m.chat;
  m.senderId = m.sender;
  ...
  m.reply = async (text, options = {}) => {
    ...
    if (replyVariant >= 2 && replyVariant <= 6) {
      try {
        const thumbPath =
          replyVariant <= 4
            ? "./assets/images/ucpai2.jpg"
            : "./assets/images/ucpai.jpg";
        ...
        if (replyVariant === 2) {
          contextInfo = {
            ...contextInfo,
            externalAdReply: {
              title: config.bot?.name || "Ucpai-AI",
          ...
          contextInfo = {
            ...
            forwardedNewsletterMessageInfo: {
              newsletterName: config.saluran?.name || "Ucpai-AI",
    ...
    if (replyVariant === 4) {
      ...
      let troliThumbnail = getCachedThumb("./assets/images/ucpai.jpg");
      ...
      quotedMsg = {
        ...
        message: {
          orderMessage: {
            ...
            status: "INQUIRY",
            surface: "CATALOG",
            message: `${config.bot?.name || "Ucpai-AI"}`,
      ...
      return sock.sendMessage(
        m.chat,
        {
          ...
          jpegThumbnail: await getCachedSharpThumb(
            join(process.cwd(), "assets/images/ucpai2.jpg"),
            300,
            300,
          ),
          caption: text,
        ...
        m.chat,
        {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              ...
              thumbnail: getCachedThumb("./assets/images/ucpai2.jpg"),
              mediaType: 1,
              sourceUrl: null,
              renderLargerThumbnail: false,
            },
        ...
        m.chat,
        {
          ...
          contextInfo: {
            ...
            externalAdReply: {
              ...
              thumbnail: getCachedThumb("./assets/images/ucpai.jpg"),
              mediaType: 1,
              sourceUrl: null,
              renderLargerThumbnail: true,
            },
      ...
      return sock.sendMessage(
        m.chat,
        {
          video: await getCachedThumb("./assets/video/ucpai.mp4"),
          caption: text,
          gifPlayback: true,
          contextInfo: {
            ...contextInfo,
    ...
    return sock.sendMessage(
      m.chat,
      {
        ...
        contextInfo: {
          externalAdReply: {
            showAdAttribution: true,
            title: preview.title || config.bot?.name || "Ucpai-AI",
            body: preview.body || "",
            mediaType: 1,
            renderLargerThumbnail: true,
