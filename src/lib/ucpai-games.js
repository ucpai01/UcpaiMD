import { getRandomItem, createSession, getSession, endSession, checkAnswerAdvanced, getHint, hasActiveSession, setSessionTimer, getRemainingTime, formatRemainingTime, isSurrender, isReplyToGame, getRandomReward, getProgressiveHint } from './ucpai-game-data.js'
import { getDatabase } from './ucpai-database.js'
import { addExpWithLevelCheck } from './ucpai-level.js'
import { getGameContextInfo, checkFastAnswer } from './ucpai-context.js'
let fetchBuffer
try { fetchBuffer = (await import('./ucpai-utils.js')).fetchBuffer } catch {}
...
const games = new UcpaiGames()

export { UcpaiGames, games }