...
import { addExifToWebp, isAnimatedWebp, DEFAULT_METADATA } from '../../src/lib/ucpai-exif.js'
...
async function handler(m, { sock, config: botConfig }) {
    ...
    if (!quoted) {
        return m.reply(
            ...
            `*ᴄᴏɴᴛᴏʜ:*\n` +
            `> \`${m.prefix}swm Ucpai-AI\`\n` +
            `> \`${m.prefix}swm Ucpai-AI|MrUcupz\` _(packname + author)_`
        )
    }
    ...
    if (!input) {
        return m.reply(
            ...
            `*ᴄᴏɴᴛᴏʜ:*\n` +
            `> \`${m.prefix}swm Ucpai-AI\`\n` +
            `> \`${m.prefix}swm Ucpai-AI|MrUcupz\` _(+ author)_`
        )
    }
