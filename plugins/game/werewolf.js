...
try {
    ...
    if (fs.existsSync(path.join(assetsPath, 'ucpai-games.jpg'))) {
        thumbWW = fs.readFileSync(path.join(assetsPath, 'ucpai-games.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'ucpai.jpg'))) {
        thumbNight = fs.readFileSync(path.join(assetsPath, 'ucpai.jpg'))
        thumbDay = fs.readFileSync(path.join(assetsPath, 'ucpai.jpg'))
    }
    if (fs.existsSync(path.join(assetsPath, 'ucpai-winner.jpg'))) {
        thumbWin = fs.readFileSync(path.join(assetsPath, 'ucpai-winner.jpg'))
    }
} catch (e) {
