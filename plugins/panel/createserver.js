...
import { checkPanelJeda, setPanelLastUsed } from '../../src/lib/ucpai-panel-jeda.js'
import { hasAccessToServer, getUserRole, VALID_SERVERS } from '../../src/lib/ucpai-roles-cpanel.js'
...
async function handler(m, { sock }) {
  ...
  try {
    ...
    await sock.sendMessage(targetUser, {
      image: fs.readFileSync("./assets/images/ucpai-v8.jpg"),
      caption: detailTxt,
      contextInfo: {
