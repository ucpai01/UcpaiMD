...
import { createGoodbyeCard } from "../../src/lib/ucpai-welcome-card.js";
import { resolveAnyLidToJid } from "../../src/lib/ucpai-lid.js";
...
Doakan yang terbaik untuknya ya.`,
  ...
  if (customMsg) {
    return customMsg
      ...
      .replace(/{bot}/gi, config.bot?.name || "Ucpai")
...
async function sendGoodbyeMessage(sock, groupJid, participant, groupMeta) {
  try {
    ...
    const {
      ...
      isLidConverted,
      lidToJid,
    } = await import("../../src/lib/ucpai-lid.js");
    ...
    if (goodbyeType === 2) {
            ...
            buttons: [
              ...
              },
              {
                ...
                buttonParamsJson: JSON.stringify({
                  ...
                  url: config.info?.website || "https://sc.ucpai.my.id/",
                }),
              },
            ],
          },
      ...
      await sock.sendMessage(groupJid, {
        ...
        contextInfo: {
          ...
          externalAdReply: {
            sourceUrl: config.info?.website || "https://sc.ucpai.my.id/",
            mediaUrl: config.info?.website || "https://sc.ucpai.my.id/",
            mediaType: 3,
            thumbnailUrl: ppUrl,
            title: `Goodbye ${userName}`,
            body: null,
